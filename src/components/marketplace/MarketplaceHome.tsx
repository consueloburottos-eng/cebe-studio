...
export default function MarketplaceHome() {
  ...
  // Consuelo AI (Botpress) — lives only in Marketplace mode, since this mode
  // is the "AI concierge" of the site. Injected on mount / torn down on
  // unmount so it never follows the visitor into Branding or SaaS.
  useEffect(() => {
