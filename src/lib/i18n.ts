...
export const UI = {
  ...
  saas: {
    es: {
      ...
      roadmap: [
        { status: "Explorando", text: "Multi-agent UX & Workflow Orchestration" },
        { status: "Aprendiendo", text: "Model Context Protocol (MCP)" },
        { status: "Experimentando", text: "Interfaces generativas & Voice UX" },
        { status: "Construyendo", text: "Nuevos componentes del Design System" },
      ],
    ...
    en: {
      ...
      roadmapTitle: "Coming Up",
      roadmap: [
        { status: "Exploring", text: "Multi-agent UX & Workflow Orchestration" },
        { status: "Learning", text: "Model Context Protocol (MCP)" },
        { status: "Experimenting", text: "Generative interfaces & Voice UX" },
        { status: "Building", text: "New Design System components" },
      ],
