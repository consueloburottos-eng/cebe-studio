      ...
      >
        ...
        <div className="flex min-h-0 flex-1">
            ...
            {NOTES.map((n) => (
              <button
                ...
                style={{
                  ...
                  color: note === n.id ? "var(--os-tx)" : "rgba(245,245,247,.6)",
          ...
          <div className="min-w-0 flex-1 overflow-y-auto px-6 py-5" style={{ color: "var(--os-tx)" }}>
              ...
              <div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-[13px]" style={{ color: "rgba(245,245,247,.6)" }}>
                      Product Designer · UX/UI
                    </div>
                  </div>
                </div>
                <p className="mt-4 max-w-[56ch] text-[14px] leading-[1.65]" style={{ color: "rgba(245,245,247,.75)" }}>
                ...
                <div className="mt-5 grid grid-cols-2 gap-3">
                  <div className="rounded-xl p-3.5" style={{ border: "1px solid var(--os-hr)" }}>
                    ...
                    <div className="mt-1 text-[11px] uppercase" style={{ color: "rgba(245,245,247,.5)" }}>
                      años de experiencia
                    </div>
                  </div>
                  <div className="rounded-xl p-3.5" style={{ border: "1px solid var(--os-hr)" }}>
                ...
                <div className="mt-5">
                  <span className="text-[11px] font-semibold uppercase" style={{ color: "rgba(245,245,247,.4)" }}>
                    Certificados
                  </span>
                  <div className="mt-2 flex flex-wrap gap-2">
                    <span
                      className="rounded-full px-3 py-1.5 text-[12px]"
                      style={{ border: "1px solid var(--os-hr)", color: "rgba(245,245,247,.7)" }}
                    >
              ...
              <div className="flex flex-col gap-4">
                {projects.map((p) => (
                  ...
                  >
                    ...
                    <div className="mt-1 text-[12.5px]" style={{ color: "rgba(245,245,247,.55)" }}>
                      {p.role} · {p.client}
                    </div>
              ...
              <div className="flex flex-col gap-4">
                {SERVICES.map((s) => (
                  <div key={s.name}>
                    ...
                    <div className="mt-1 text-[13px] leading-[1.5]" style={{ color: "rgba(245,245,247,.65)" }}>
                      {s.desc}
                    </div>
                  </div>
                ))}
            ...
            {note === "contacto" && (
              <div>
                <p className="max-w-[46ch] text-[14px] leading-[1.6]" style={{ color: "rgba(245,245,247,.75)" }}>
