...
const baseProjects: Project[] = [
  ...
  },
  {
    ...
    role: "UX/UI Design Lead",
    year: "—",
    result: "Calendario integrado con vista detallada de reuniones, disponibilidad configurable y sincronización con Google Calendar y Outlook",
    services: "UX Research · UI · Design Systems",
    skills: [
      "Figma",
      "UX Research",
    ...
    coverMedia: img("altafid", "03.jpg"),
    brief:
      "Diseñé el módulo de Calendar para una plataforma B2B de inversión usada por asesores financieros y roles dentro de instituciones financieras, donde reuniones, llamadas, contactos, casos de inversión, notas y disponibilidad necesitan vivir conectados en vez de dispersos. El reto de diseño no era crear \"un calendario más\": era resolver por qué un asesor adoptaría una herramienta nueva cuando ya tenía Google Calendar u Outlook en uso diario, y cómo lograr que ambos convivieran sin fricción en vez de forzar una migración completa.",
    strategy: [
      "La primera decisión fue tratar la sincronización como el problema central, no como un detalle técnico secundario. En el primer uso se muestra un modal que invita a sincronizar con el calendario externo del usuario, con opción de omitirlo. Si el asesor no sincroniza, diseñé un mensaje recordatorio que aparece cada vez que entra a Calendar —pero que se puede cerrar en el momento— a diferencia del modal, que si se descarta con \"no volver a preguntar\" no vuelve a aparecer nunca más. Ese recordatorio reaparece en cada nueva sesión mientras la cuenta siga sin sincronizar, manteniendo visible el estado sin bloquear el flujo de trabajo.",
      "Una vez sincronizado, el flujo normal permite seleccionar la disponibilidad propia, cambiar entre distintas vistas del calendario y saltar rápidamente al día actual con un botón de \"Hoy\". Los roles con mayor autoridad pueden además revisar el calendario de otras personas dentro de la organización, no solo el propio. Un evento se crea haciendo clic directamente en una celda del calendario o desde un botón principal, y al hacer clic sobre un evento existente se abre una vista de detalle con invitados, descripción, notas, link a la reunión y la opción de agregar más personas —desde ahí también se puede cancelar, reprogramar o confirmar el evento.",
    ],
    headline: "de dos calendarios separados a uno sincronizado",
    en: {
      tag: "product · fintech · scheduling",
      subtitle: "From scheduling over email to an integrated calendar with real-time availability",
      result: "An integrated calendar with a detailed meeting view, configurable availability, and Google Calendar / Outlook sync",
      services: "UX Research · UI · Design Systems",
      skills: [
        "Figma",
        "User Research",
      ...
      brief:
        "I designed the Calendar module for a B2B investment platform used by financial advisors and institutional roles, where meetings, calls, contacts, investment cases, notes, and availability need to live connected instead of scattered. The design challenge wasn't building \"another calendar\": it was figuring out why an advisor would adopt a new tool when they already used Google Calendar or Outlook daily, and how to make both coexist without friction instead of forcing a full migration.",
      strategy: [
        "The first decision was treating sync as the core problem, not a secondary technical detail. On first use, a modal invites the advisor to sync their external calendar, with an option to skip it. If they don't sync, I designed a reminder message that appears every time they enter Calendar — but can be dismissed in the moment — unlike the modal, which if dismissed with \"don't ask again\" never reappears. That reminder resurfaces on every new session as long as the account remains unsynced, keeping the state visible without blocking the workflow.",
        "Once synced, the normal flow lets the advisor select their own availability, switch between different calendar views, and jump quickly to the current day with a \"Today\" button. Roles with higher authority can also review other people's calendars within the organization, not just their own. An event is created by clicking directly on a calendar cell or from a primary button, and clicking an existing event opens a detail view with guests, description, notes, a meeting link, and the option to add more people — from there you can also cancel, reschedule, or confirm the event.",
      ],
      headline: "from two separate calendars to one synced calendar",
    },
    gallery: [
      { label: "Altafid Calendar — imagen 1", media: img("altafid", "feature-calendar-01.webp") },
      { label: "Altafid Calendar — imagen 2", media: img("altafid", "feature-calendar-02.webp") },
      { label: "Altafid Calendar — imagen 3", media: img("altafid", "feature-calendar-03.webp") },
      { label: "Altafid Calendar — imagen 4", media: img("altafid", "feature-calendar-04.webp") },
      { label: "Altafid Calendar — imagen 5", media: img("altafid", "feature-calendar-05.webp") },
      { label: "Altafid Calendar — imagen 6", media: img("altafid", "feature-calendar-06.webp") },
      { label: "Altafid Calendar — imagen 7", media: img("altafid", "feature-calendar-07.webp") },
      { label: "Altafid Calendar — imagen 8", media: img("altafid", "feature-calendar-08.webp") },
      { label: "Altafid Calendar — imagen 9", media: img("altafid", "feature-calendar-09.webp") },
      { label: "Altafid Calendar — imagen 10", media: img("altafid", "feature-calendar-10.webp") },
      { label: "Altafid Calendar — imagen 11", media: img("altafid", "feature-calendar-11.webp") },
      { label: "Altafid Calendar — imagen 12", media: img("altafid", "feature-calendar-12.webp") },
      { label: "Altafid Calendar — imagen 13", media: img("altafid", "feature-calendar-13.webp") },
      { label: "Altafid Calendar — imagen 14", media: img("altafid", "feature-calendar-14.webp") },
      { label: "Altafid Calendar — imagen 15", media: img("altafid", "feature-calendar-15.webp") },
    ],
  },
  {
