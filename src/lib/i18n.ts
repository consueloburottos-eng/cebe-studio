...
export const UI = {
  ...
  projectDetail: {
    es: {
      ...
      siteCredit: "© 2026 Consuelo Burotto — construido con Claude Code",
    ...
    en: {
      ...
      siteCredit: "© 2026 Consuelo Burotto — built with Claude Code",
  ...
  about: {
    es: {
      tabs: { perfil: "Perfil", snapshot: "Talent", experiencia: "Experiencia", skills: "Skills", servicios: "Servicios", book: "Agéndame" },
      ...
      copied: "Copiado ✓",
      scheduleCalendly: "Agendar en Calendly",
      ...
      services: [
        ...
        { name: "Diseño responsivo", desc: "Interfaces de arquitectura escalable que se integran a todo tipo de pantalla y dispositivo." },
        { name: "Seguridad y confianza", desc: "Infraestructura robusta para un producto estable, seguro y confiable." },
        { name: "IA y flujos data-driven", desc: "Experiencias impulsadas por IA y decisiones de diseño basadas en datos reales." },
      ],
    },
    en: {
      tabs: { perfil: "Profile", snapshot: "Talent", experiencia: "Experience", skills: "Skills", servicios: "Services", book: "Book me" },
      ...
      services: [
        ...
        { name: "Responsive Design", desc: "Scalable interfaces that adapt seamlessly to any screen and device." },
        { name: "Security & Trust", desc: "Robust infrastructure for a stable, secure, and reliable product." },
        { name: "AI & Data-Driven Flows", desc: "AI-powered experiences and design decisions grounded in real data." },
      ],
    },
  },
  saas: {
  ...
  marketplace: {
    es: {
      ...
      noFavoritesYet: "Todavía no guardaste ningún servicio.",
    ...
    en: {
      ...
      noFavoritesYet: "You haven't saved any services yet.",
